...
class AudioConfig:
    ...
    # 固定配置
    INPUT_SAMPLE_RATE = 48000  # USB Camera 麦克风的采样率
    OUTPUT_SAMPLE_RATE = 48000  # 保持与输入采样率一致
    CHANNELS = 1  # 单声道
    ...
    # 音频设备配置
    INPUT_DEVICE = "hw:2,0"  # USB Camera 麦克风设备
    OUTPUT_DEVICE = "hw:3,0"  # USB PnP Audio Device 作为输出设备
