...
def setup_logging():
    ...
    root_logger.setLevel(logging.DEBUG)  # 设置根日志级别为DEBUG
    ...
    console_handler.setLevel(logging.DEBUG)  # 设置控制台处理器级别为DEBUG
    ...
    # 输出日志配置信息
    logging.info("日志系统已初始化，日志级别: DEBUG，日志文件: %s", log_file)
